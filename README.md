...
A structured 6-month program to become an ML Engineer specialising in 
AI for Financial Services. Built from scratch, with real data, every day.

**By:** Mrigank Agrawal  
**Background:** Finance & Real Estate → ML Engineering  
**Target:** AI/ML Engineer in UK Financial Services  
**Started:** March 2026
...
Finance and real estate professional transitioning into ML Engineering.
I build data-driven projects using real financial data from credible 
sources — LSE, HM Land Registry, Bank of England, and more.

Every notebook in this repo uses real data. No toy datasets.

📍 Manchester, UK  
💼 [LinkedIn](https://www.linkedin.com/in/mrigank-agrawal/)  
🐙 [GitHub](https://github.com/mrigank-agrawal)